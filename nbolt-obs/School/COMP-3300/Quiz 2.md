...
Consider the following synchronization code using semaphores for two threads, $T_{1}$ and $T_{2}$, running concurrently on the same core (context switching can occur at any point).
...
### Identify whether the following are true/false:
...
### Draw the RAG using the given information
